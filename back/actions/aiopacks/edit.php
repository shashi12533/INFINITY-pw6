...
$sql  = "SELECT `id`, `name`, `description`, `img` FROM `aiopacks` WHERE `id` = $_POST[id];
";
...
<label style="font-size: 24px;">Ajouter une planète : </label><br><br>
    ...
    <textarea type="text" name="description"><?= $row["description"] ?></textarea><br>
    <label style="width: 100px" for="link">Image :</label>
    <input value="<?= $row["img"] ?>" type="url" name="img"><img style="width: 100px;" src="<?= $row["img"] ?>" alt="<?= $row["name"]?>"><br><br><br>
</div>
<input type="hidden" name="id" value="<?=$row["id"]?>">
<a href="../../index.php#aiopacks" class="btn btn-danger">Annuler</a>
