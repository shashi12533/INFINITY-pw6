...
$sql = "SELECT `id`,`name`,`age`,`nationality`,`size`,`weight`,`allergy`,`diet`,`infirmity`,`medication`,`respiratory`,`mental`,`cardiac`,`fear`,`alcohol`,`drug`,`family`,`pregnant`,`professional`,`phone`,`mail`,`address`
FROM `user`
WHERE `id` = $_POST[id]";
...
<div class="form-group">
  ...
  <form class="form" action="./doedit.php" method="post">
    ...
    <label>Age</label>
    <input type="date" name="age" value="<?=$row['age']?>"></input>
    <label>Nationality</label>
  <input type="text" name="nationality" value="<?=$row['nationality']?>"></input>
  <label>Size</label>
    <input type="number" name="size" value="<?=$row['size']?>"></input>
      <label>Weight</label>
    <input type="number" name="weight" value="<?=$row['weight']?>"></input>
    <label>Allergy</label>
    <input type="text" name="allergy" value="<?=$row['allergy']?>"></input>
    <label>Diet</label>
    <input type="text" name="diet" value="<?=$row['diet']?>"></input>
    <label>Infirmity</label>
    <input type="text" name="infirmity" value="<?=$row['ifirmity']?>"></input>
    <label>Medication</label>
    <input type="text" name="medication" value="<?=$row['medication']?>"></input>
    <label>Respiratory Issues</label>
    <input type="text" name="respiratory" value="<?=$row['respiratory']?>"></input>
    <label>Mental issues</label>
    <input type="text" name="mental" value="<?=$row['mental']?>"></input>
    <label>Cardiac Issues</label>
    <input type="text" name="cardiac" value="<?=$row['cardiac']?>"></input>
    <label>Fears</label>
    <input type="text" name="fear" value="<?=$row['fears']?>"></input>
<label>Alcohol</label>
    <select class="alcohol" name="alcohol" value="<?=$row['alcohol']?>">
    ...
    <label>Drugs</label>
    <select class="drug" name="drugs" value="<?=$row['drugs']?>">
      <option value="never">Never</option>
      <option value="2times">Hard drugs</option>
      <option value="2times">WEED only</option>
      <option value="everyday">Toxico</option>
      <option value="2times">Junky</option>
    </select>
    <label>Family</label>
    <input type="text" name="family" value="<?=$row['family']?>"></input>
    <label>Pregnancy</label>
    <input type="text" name="pregnacy" value="<?=$row['pregnant']?>"></input>
    <label>Profession</label>
    <input type="text" name="profession" pvalue="<?=$row['professional']?>"></input>
    <label>Phone</label>
    <input type="phone" name="phone" value="<?=$row['phone']?>"></input>
    <label>Mail</label>
    <input type="mail" name="mail" value="<?=$row['mail']?>"></input>
    <label>Address</label>
    <input type="text" name="address" value="<?=$row['address']?>"></input>
    <button type="submit" name="submit" value="SUBMIT" class="btn btn-info">Envoyer</button>
      </div>
  </form>
  </div>
  </div>
