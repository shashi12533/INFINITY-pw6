...
<div class="form-group">
    <label style="font-size: 24px">Modifier la station <?= $row["name"] ?> : </label><br><br>
	...
	<input placeholder="Work" value="<?= $row["staff"] ?>" type="text" name="staff"></input><br>
...
<a href="../../index.php#station" class="btn btn-danger">Annuler</a>
