...
$sql = "UPDATE `db_space`.`ship` SET `name`=:name, `size`=:size, `air`=:air, `duration`=:duration, `spacing`=:spacing, `connection`=:connection, `installations`=:installations, `link`=:link WHERE `id`=:id
;";
