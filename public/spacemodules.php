...
<body>
    <section class="spacemodules">
        ...
        <p class="spacemodules_goto">Découvrez aussi nos <a href="custompacks.php" class="spacemodules_goto_link">PACKS PERSONNALISABLES</a>, ainsi que nos <a href="aiopacks.php" class="spacemodules_goto_link">PACKS TOUT INCLUS</a></p>
        <footer class="footer">
